...
>>>>>>> refs/remotes/seya/master
						...
						<li class="user-footer">
							...
							<div class="pull-left">
								<a href="${pageContext.request.contextPath}/main1" class="btn btn-default btn-flat">로그인</a>
							</div>
							<div class="pull-right">
								<a href="${pageContext.request.contextPath}/main2" class="btn btn-default btn-flat">회원가입</a>
							</div>
							<div class="pull-center">
								<a href="${pageContext.request.contextPath}/mypage/gallery" class="btn btn-default btn-flat">잠시</a>
							</div>
							</c:if>
							<!-- 세션을 가지고 있는 상태 -->
							<c:if test="${not empty sessionScope.id }">
							<div class="pull-left">
								<a href="${pageContext.request.contextPath}/${sessionScope.id}/profilemodify" class="btn btn-default btn-flat">정보수정</a>
							</div>
							<div class="pull-right">
								<a href="${pageContext.request.contextPath}/logout.do" class="btn btn-default btn-flat">로그아웃</a>
							</div>
							<div class="pull-center">

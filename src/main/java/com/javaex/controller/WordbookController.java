...
public class WordbookController {
	...
	public String wordbook(String keyword, URLPathVo urlPathVo, PagingVo pagingVo, Model md, Device device) {
		...
		// 리스트 잘라주는 문장 들어가야함
		try {
			wordbookList = wordbookList.subList(pagingVo.getListCnt() * (pagingVo.getIndex() - 1),
